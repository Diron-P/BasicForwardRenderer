...
namespace Math {
    ...
    public:
        ...
        Matrix44(const Vector3& vx, const Vector3& vy, const Vector3& vz, const Vector3& vw);
   ...
   inline  Matrix44::Matrix44()
    ...
    inline Matrix44::Matrix44(const Vector3& vx, const Vector3& vy, const Vector3& vz, const Vector3& vw)
    {
        m[0][0] = vx.x; m[0][1] = vx.y; m[0][2] = vx.z; m[0][3] = 0.0f;
        m[1][0] = vy.x; m[1][1] = vy.y; m[1][2] = vy.z; m[1][3] = 0.0f;
        m[2][0] = vz.x; m[2][1] = vz.y; m[2][2] = vz.z; m[2][3] = 0.0f;
